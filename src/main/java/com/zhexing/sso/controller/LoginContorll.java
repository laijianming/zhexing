...
public class LoginContorll {
	...
	public ZheXingResult Login( HttpServletRequest request){
		...
		System.out.println("uname:"+uname+" pass:"+upassword);
		...
		if(result.getStatus()==200){
			String token=(String) result.getMsg();//通过msg来接受登陆时产生的令牌token
...
//		  return result;
	...
	public ZheXingResult updateUserMessage(String uname,String uemail,String unickname,String newuname,String uphone,String token){
		System.out.println("updateUserMessage!!");
			System.out.println("uname:"+uname+"uemail:"+uemail+" unickname:"+unickname+" newuname:"+newuname+" uphone"+uphone);
