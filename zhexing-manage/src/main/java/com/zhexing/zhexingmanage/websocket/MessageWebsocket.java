package com.zhexing.zhexingmanage.websocket;

import com.zhexing.zhexingmanage.domain.WsUser;
import com.zhexing.zhexingmanage.utils.JsonUtils;
...
public class MessageWebsocket {
    ...
    public void messageDeal(){
        ...
        // 将队列绑定到交换机
        rabbit.declareBinding(new Binding(WS_MANAGER_EXCHANGE,Binding.DestinationType.QUEUE,WS_MSG_EXCHANGE,WS_MANAGER_ROUTINGKEY,new HashMap<>()));
