...
public class DynamicCRUDDaoImpl_cloud implements DynamicCRUDDao {
//private SolrServer solrServer=new HttpSolrServer("http://192.168.134.128:9999/solr/DynamicCollection");
//private String zkHost="192.168.134.128:2181,192.168.134.128:2182,192.168.134.128:2183";
private String zkHost="129.204.212.52:2191,129.204.212.52:2192,129.204.212.52:2193";
private CloudSolrServer solrServer=new CloudSolrServer(zkHost);
public DynamicCRUDDaoImpl_cloud(){
...
@Override
	public dynamicResult search(SolrQuery solrQuery) throws SolrServerException, ParseException {
		...
		for(SolrDocument doc:documentList){
			...
			item.setUser_id((Long)doc.get("user_id"));
